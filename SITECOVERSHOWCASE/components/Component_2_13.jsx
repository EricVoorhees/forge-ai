import Component_2_13_1 from './Component_2_13_1';

function Component_2_13() {
  return (
    <div
      className="w-[calc(50%_-_13px)] overflow-x-hidden overflow-y-hidden rounded-br-[12px] rounded-t-[12px] rounded-bl-[12px]"
      data-component-id="Component_2_13"
    >
      <div className="[--mouse-x:485px] [--mouse-y:160.453125px] [--spotlight-color:rgba(255,255,255,0.25)] h-full relative overflow-x-hidden overflow-y-hidden">
        <div
          id="home_blog_id_qwen3-coder-next"
