  ...
  return (
    ...
    >
      <div
        ...
        data-style-id="style-3-1772840596782"
      >
        <img
          src="https://img.alicdn.com/imgextra/i3/O1CN01kWYOKx1vNnFZyhTbu_!!6000000006161-2-tps-1590-954.png"
          alt="Thinking"
      ...
      <div className="text-[#797b89] leading-[24px] text-ellipsis w-full h-[72px] min-h-6 max-h-[72px] flow-root overflow-x-hidden overflow-y-hidden caret-[#797b89] my-4">
        Qwen excels in advanced reasoning and problem-solving. This enables it
        to tackle complex issues with clarity and precision, leveraging
        real-time internet data to deliver comprehensive, logical, and
