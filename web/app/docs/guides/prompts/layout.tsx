...
export const metadata: Metadata = {
  ...
  description: "Master prompt engineering for the Open Frame API. Learn techniques for code generation, reasoning tasks, and getting the best results from the 671B parameter model.",
  ...
  openGraph: {
    ...
    description: "Master prompt engineering for code generation and reasoning with our state-of-the-art FORGE model.",
