...
export const metadata: Metadata = {
  title: "Node.js SDK",
  description: "Official FORGE Node.js SDK documentation. Install, configure, and use the JavaScript/TypeScript client library for the FORGE API with full TypeScript support.",
  ...
  twitter: {
    ...
    description: "Official Node.js/TypeScript client library for the FORGE API.",
    images: ["/og-image.png"],
  },
};
