...
export const metadata: Metadata = {
  ...
  description: "Integrate FORGE Audit into your CI/CD pipeline. Complete setup guides for GitHub Actions, GitLab CI, Jenkins, and CircleCI with automated security scanning on every commit.",
  keywords: [
    "CI/CD security",
  ...
  twitter: {
    ...
    title: "FORGE Audit CI/CD Integration",
